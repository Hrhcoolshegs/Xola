          ...
          {step === 1 && (
            <div className="flex flex-col items-center">
              ...
              >
                ...
                <h3 className="text-lg font-medium text-gray-800 mb-2">{t('clinical.upload')}</h3>
              ...
              {uploadedFiles.length > 0 && (
                <div className="w-full max-w-2xl">
                  ...
                  <h3 className="text-lg font-medium text-gray-800 mb-4">{t('clinical.history')}</h3>
                  ...
                  <Card title="Patient Data Collection">
                    {selectedPatient ? (
                      ...
                      <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <h3 className="text-lg font-medium text-gray-800 mb-2">Please Select a Patient</h3>
